...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <section className="hero-section" data-testid="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-text">
            <h1 data-testid="hero-title">Plant Disease Detection Using Deep Learning</h1>
          ...
          <div className="hero-image">
            <img 
              src="https://images.unsplash.com/photo-1636089944769-4c5ae2ba468a?crop=entropy&cs=srgb&fm=jpg&q=85" 
      ...
      <section id="architecture" className="content-section" data-testid="architecture-section">
        <h2 className="section-title">Detailed Model Architecture</h2>
        <div className="architecture-box">
          <div className="architecture-layer">
            <span className="layer-name">Input Layer</span>
            <span className="layer-details">Shape: (224, 224, 3) - RGB Image</span>
          </div>
          <div className="architecture-layer">
            <span className="layer-name">ResNet50 Base</span>
            <span className="layer-details">23M Parameters (Frozen) - Pre-trained Feature Extractor</span>
          </div>
          <div className="architecture-layer">
            <span className="layer-name">Global Average Pooling</span>
            <span className="layer-details">Output: (2048,) - Spatial Dimension Reduction</span>
          </div>
          <div className="architecture-layer">
            <span className="layer-name">Dense Layer</span>
            <span className="layer-details">256 Units + ReLU Activation + Batch Normalization</span>
          </div>
          <div className="architecture-layer">
            <span className="layer-name">Dropout</span>
            <span className="layer-details">Rate: 0.5 - Regularization</span>
          </div>
          <div className="architecture-layer">
            <span className="layer-name">Output Layer</span>
            <span className="layer-details">39 Units + Softmax - Disease Classification</span>
          </div>
        </div>
        <div className="section-content" style={{ marginTop: "2rem" }}>
          <p>
            <strong>Total Parameters:</strong> 23.5M | <strong>Trainable Parameters:</strong> 534k | 
            <strong>Training Time:</strong> ~2 hours on GPU | <strong>Inference Time:</strong> ~100ms per image
          </p>
        </div>
      </section>
      ...
      <section id="performance" className="content-section" data-testid="performance-section">
        ...
        <div className="cards-grid">
          ...
          <div className="info-card">
            ...
            <p>Weighted average recall across all classes</p>
          </div>
          <div className="info-card">
            <h3>F1-Score</h3>
            <p style={{ fontSize: "2.5rem", fontWeight: "700", color: "#166534", marginTop: "1rem" }}>
        ...
        <div className="metrics-table-container" data-testid="model-summary-table">
          <h3 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "1.75rem", color: "#166534", marginBottom: "1.5rem" }}>
            Model Architecture Summary
          </h3>
          <table className="model-summary-table">
            <thead>
              <tr>
                <th>Layer (type)</th>
                <th>Output Shape</th>
            ...
            <tbody>
              <tr>
                <td className="layer-type">sequential (Sequential)</td>
                <td>(None, 224, 224, 3)</td>
                <td>0</td>
              </tr>
              <tr>
                <td className="layer-type">lambda (Lambda)</td>
                <td>(None, 224, 224, 3)</td>
                <td>0</td>
              </tr>
              <tr>
                <td className="layer-type">resnet50 (Functional)</td>
                <td>(None, 7, 7, 2048)</td>
                <td>23,587,712</td>
              </tr>
              <tr>
                <td className="layer-type">global_average_pooling2d (GlobalAveragePooling2D)</td>
                <td>(None, 2048)</td>
                <td>0</td>
              </tr>
              <tr>
                <td className="layer-type">dense (Dense)</td>
                <td>(None, 256)</td>
                <td>524,544</td>
              </tr>
              <tr>
                <td className="layer-type">dropout (Dropout)</td>
                <td>(None, 256)</td>
                <td>0</td>
              </tr>
              <tr>
                <td className="layer-type">dense_1 (Dense)</td>
                <td>(None, 39)</td>
                <td>10,023</td>
              </tr>
              <tr className="total-row">
                <td colSpan="2"><strong>Total params</strong></td>
                <td><strong>24,122,279</strong></td>
              </tr>
              <tr className="total-row">
                <td colSpan="2"><strong>Trainable params</strong></td>
                <td><strong>534,567</strong></td>
              </tr>
              <tr className="total-row">
                <td colSpan="2"><strong>Non-trainable params</strong></td>
                <td><strong>23,587,712</strong></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="metrics-table-container" data-testid="classification-report">
          <h3 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "1.75rem", color: "#166534", marginBottom: "1.5rem" }}>
            Detailed Classification Report (F1 Scores)
          </h3>
          <table className="metrics-table">
            ...
            <tbody>
              <tr>
                <td className="class-name">Apple - Apple scab</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.99</td>
                <td>151</td>
              </tr>
              <tr>
                <td className="class-name">Apple - Black rot</td>
                <td className="score high-score">0.97</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.99</td>
                <td>147</td>
              </tr>
              <tr>
                <td className="class-name">Apple - Cedar apple rust</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>125</td>
              ...
              <tr>
                <td className="class-name">Apple - healthy</td>
                <td className="score high-score">0.97</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.98</td>
                <td>246</td>
              </tr>
              <tr>
                <td className="class-name">Background without leaves</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.99</td>
                <td>172</td>
              ...
              <tr>
                <td className="class-name">Blueberry - healthy</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>226</td>
              ...
              <tr>
                <td className="class-name">Cherry - Powdery mildew</td>
                <td className="score high-score">0.98</td>
                <td className="score high-score">0.97</td>
                <td className="score high-score">0.98</td>
                <td>158</td>
              ...
              <tr>
                <td className="class-name">Cherry - healthy</td>
                <td className="score high-score">0.94</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.97</td>
                <td>151</td>
              </tr>
              <tr>
                <td className="class-name">Corn - Cercospora leaf spot Gray leaf spot</td>
                <td className="score high-score">0.95</td>
                <td className="score high-score">0.95</td>
                <td className="score high-score">0.95</td>
                <td>151</td>
              </tr>
              <tr>
                <td className="class-name">Corn - Common rust</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>179</td>
              ...
              <tr>
                <td className="class-name">Corn - Northern Leaf Blight</td>
                <td className="score high-score">0.95</td>
                <td className="score high-score">0.95</td>
                <td className="score high-score">0.95</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Corn - healthy</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.99</td>
                <td>175</td>
              ...
              <tr>
                <td className="class-name">Grape - Black rot</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.98</td>
                <td className="score high-score">0.99</td>
                <td>178</td>
              ...
              <tr>
                <td className="class-name">Grape - Esca (Black Measles)</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.99</td>
                <td>208</td>
              ...
              <tr>
                <td className="class-name">Grape - Leaf blight (Isariopsis Leaf Spot)</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>162</td>
              ...
              <tr>
                <td className="class-name">Grape - healthy</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Orange - Haunglongbing (Citrus greening)</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>827</td>
              ...
              <tr>
                <td className="class-name">Peach - Bacterial spot</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.98</td>
                <td className="score high-score">0.99</td>
                <td>345</td>
              ...
              <tr>
                <td className="class-name">Peach - healthy</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.96</td>
                <td className="score high-score">0.98</td>
                <td>151</td>
              </tr>
              <tr>
                <td className="class-name">Pepper, bell - Bacterial spot</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.98</td>
                <td className="score high-score">0.99</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Pepper, bell - healthy</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.94</td>
                <td className="score high-score">0.97</td>
                <td>222</td>
              ...
              <tr>
                <td className="class-name">Potato - Early blight</td>
                <td className="score high-score">0.98</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.99</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Potato - Late blight</td>
                <td className="score high-score">0.95</td>
                <td className="score high-score">0.96</td>
                <td className="score high-score">0.96</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Potato - healthy</td>
                <td className="score high-score">0.98</td>
                <td className="score high-score">0.98</td>
                <td className="score high-score">0.98</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Raspberry - healthy</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Soybean - healthy</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>764</td>
              ...
              <tr>
                <td className="class-name">Squash - Powdery mildew</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>276</td>
              ...
              <tr>
                <td className="class-name">Strawberry - Leaf scorch</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>167</td>
              ...
              <tr>
                <td className="class-name">Strawberry - healthy</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">1.00</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Tomato - Bacterial spot</td>
                <td className="score high-score">0.97</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.98</td>
                <td>320</td>
              ...
              <tr>
                <td className="class-name">Tomato - Early blight</td>
                <td className="score high-score">0.96</td>
                <td className="score">0.81</td>
                <td className="score">0.88</td>
                <td>151</td>
              </tr>
              <tr>
                <td className="class-name">Tomato - Late blight</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.96</td>
                <td className="score high-score">0.97</td>
                <td>286</td>
              ...
              <tr>
                <td className="class-name">Tomato - Leaf Mold</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.92</td>
                <td className="score high-score">0.96</td>
                <td>151</td>
              </tr>
              <tr>
                <td className="class-name">Tomato - Septoria leaf spot</td>
                <td className="score high-score">0.92</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.96</td>
                <td>266</td>
              ...
              <tr>
                <td className="class-name">Tomato - Spider mites Two-spotted spider mite</td>
                <td className="score high-score">0.95</td>
                <td className="score high-score">0.96</td>
                <td className="score high-score">0.95</td>
                <td>252</td>
              ...
              <tr>
                <td className="class-name">Tomato - Target Spot</td>
                <td className="score">0.91</td>
                <td className="score high-score">0.96</td>
                <td className="score">0.93</td>
                <td>211</td>
              </tr>
              <tr>
                <td className="class-name">Tomato - Tomato Yellow Leaf Curl Virus</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">0.99</td>
                <td>804</td>
              ...
              <tr>
                <td className="class-name">Tomato - Tomato mosaic virus</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td>151</td>
              ...
              <tr>
                <td className="class-name">Tomato - healthy</td>
                <td className="score high-score">0.99</td>
                <td className="score high-score">1.00</td>
                <td className="score high-score">0.99</td>
                <td>238</td>
              ...
              <tr className="total-row">
                ...
                <td colSpan="3"><strong>0.98</strong></td>
